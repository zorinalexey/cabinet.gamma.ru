...
final class DocumentService
{
     ...
     * @var PhpWord|null
     */
    public static PhpWord|null $docx = null;

    /**
     * @var string|null
     */
    public static string|null $hash = null;
     ...
     * @var string|null
     */
    private static string|null $doc_number = null;
     ...
     * @return string|null
     */
    public static function createSignDocument(UserDocument $document, string $sign_code): string|null
    {
        $user = $document->user;
     ...
     * @return string|null
     */
    public static function createBlankBulletin(User $user, Omitted $omitted, string|bool|null $sign = null): string|null
    {
        self::$user = $user;
     ...
     * @param bool|null $is_sign
     * @return void
     */
    public static function addUserDocuments(string $name, string|null $file, bool|null $is_sign = null, string|null $signCode = null): void
    {
        $is_sign ??= true;
     ...
     * @return string|null
     */
    public static function getLink(User $user, UserRubleAccount $account, Fund $fund, UserDocument $document, string $document_name): string|null
    {
        $config = config('company_details');
